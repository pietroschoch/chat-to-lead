...
export function OpenChatButton({ onClick }: OpenChatButtonProps) {
  return (
    <div className="flex items-center gap-2 md:gap-3 fixed bottom-4 right-4 cursor-pointer group hover:bottom-5 transition-all ease-linear" onClick={onClick}>
      ...
      <span className="bg-white p-2 md:p-4 rounded-2xl rounded-br-none text-xs md:text-lg leading-tight md:leading-6 flex-1 w-[calc(100vw-6rem)] sm:w-64 md:w-80 shadow-lg group-hover:shadow-2xl group-hover:shadow-emerald-500/50 transition-all ease-linear">
